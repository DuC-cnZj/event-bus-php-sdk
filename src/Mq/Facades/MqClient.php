...
/**
 *
 * @method static \Google\Protobuf\GPBEmpty|array publish($queue = '', $data = '', $expirationSeconds = 0, bool $asArray = true, $metadata = [], $options = [])
 * @method static \Google\Protobuf\GPBEmpty|array delayPublish($queue = '', $data = '', $delaySeconds = 0, $expirationSeconds = 0, bool $asArray = true, $metadata = [], $options = [])
